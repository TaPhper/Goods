	...
	<body>
		...
		<div class="am-container header">
			<ul class="message-l">
				<div class="topMessage">
					<div class="menu-hd">
						...
						<a href="login.html" target="_top">免费注册</a>
					</div>
				</div>
			</ul>
			<ul class="message-r">
			...
			<div class="nav white">
				...
				<div class="logoBig">
					<li><a href="/"><img src="/home/images/logobig.png" /></a></li>
				</div>
						...
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								...
								<li class="price iteminfo_mktprice">
									<dt>原价</dt>
									<dd><em>¥</em><b class="sys_item_mktprice">{{$goods_one[0]->market_price}}.00</b></dd>									
								</li>
								<div class="clear"></div>
							</div>
					...
					<div class="match-comment">
						<ul class="like_list">
							...
							<li class="total_price">
								...
								<p class="save_all">共省:<span>￥463.00</span></p> <a href="pay.html" class="buy_now">立即购买</a> </li>
